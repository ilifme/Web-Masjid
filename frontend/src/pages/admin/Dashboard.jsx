...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      subtitle: ${stats?.stats?.photos || 0} Foto,  Video,
    },
    {
      ...
      {stats?.donationSummary && (
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Target Total</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                Rp {parseFloat(stats.donationSummary.totalTarget || 0).toLocaleString('id-ID')}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Terkumpul</p>
              <p className="text-2xl font-bold text-primary-600 dark:text-primary-400">
                Rp {parseFloat(stats.donationSummary.totalCollected || 0).toLocaleString('id-ID')}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Persentase</p>
          ...
          <div className="mt-4">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
              <div
                ...
                style={{ width: ${Math.min(stats.donationSummary.percentage, 100)}% }}
              ></div>
            </div>
          </div>
        </div>
